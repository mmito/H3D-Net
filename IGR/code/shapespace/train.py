...
class ShapeSpaceRunner:
    ...
    def run(self):
        ...
        for epoch in range(self.startepoch, self.nepochs + 1):
            print("Checkpoint frequency:", self.conf.get_int('train.checkpoint_frequency'))
    ...
    def save_checkpoints(self,epoch):
        print(os.path.join(self.checkpoints_path, self.model_params_subdir, str(epoch) + ".pth"))
        torch.save(
