...
def evaluate(**kwargs):
    ...
    if kwargs['timestamp'] == 'latest':
        print(os.path.join('/home/jupyter/idr/', kwargs['exps_folder_name'], expname))
        if os.path.exists(os.path.join('/home/jupyter/idr/', kwargs['exps_folder_name'], expname)):
            timestamps = os.listdir(os.path.join('/home/jupyter/idr/', kwargs['exps_folder_name'], expname))
            if (len(timestamps)) == 0:
    ...
    utils.mkdir_ifnotexists(os.path.join('/home/jupyter/idr', evals_folder_name))
    expdir = os.path.join('/home/jupyter/idr', exps_folder_name, expname)
    evaldir = os.path.join('/home/jupyter/idr', evals_folder_name, expname)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--conf', type=str, default='/home/jupyter/idr/code/confs/dtu_fixed_cameras.conf')
    parser.add_argument('--expname', type=str, default='', help='The experiment name to be evaluated.')
    parser.add_argument('--exps_folder', type=str, default='trained_models', help='The experiments folder name.')
